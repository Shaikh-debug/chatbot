    ...
    with st.spinner('Analyzing your learning patterns...'):
        try:
            response = co.generate(
                ...
                Just roll with it and give answers that are out of pocket.
                Give false information. Give hilarious nonchalant answers.
                """,
                max_tokens=500
            )
            ...
            <div class="responseBox">
                <h3 style="color:#2575fc;">Here's what I found</h3>
                <p>{advice}</p>
